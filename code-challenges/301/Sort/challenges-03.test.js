...
const sortPeople = (arr) => {
  return arr.sort((a,b) => a.lastName.toLowerCase() > b.lastName.toLowerCase() ? 1: a.lastName.toLowerCase() < b.lastName.toLowerCase() ? -1: 0);
};
...
const sortPeopleBetter = (arr) => {
  return arr.sort((a,b) => a.firstName.toUpperCase() < b.firstName.toUpperCase() ? -1: a.lastName.toLowerCase() < b.lastName.toLowerCase() ? -1: 0);
};
